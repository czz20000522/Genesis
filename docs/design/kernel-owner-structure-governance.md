...
| `internal/kernel/resource` | resource registry, resource read, future generic context hydration | Resource refs, bounded reads, grants, and hydration facts have a stable owner API. |
