...
- Verification: Remaining verification must prove richer views expose recovery-required/dead-lettered/source-failed state without interpreting raw kernel events, and future reconciliation commands preserve kernel fact isolation without resending ambiguous external effects.
