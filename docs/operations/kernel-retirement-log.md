...
- Residual risk: supersession is still future work. It should be added as an explicit replacement review event rather than mutating rejected candidates into approved truth.
